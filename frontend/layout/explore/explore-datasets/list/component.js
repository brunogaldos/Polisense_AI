            ...
            {!loading && list.map((dataset) => (
              ...
              >
                <DatasetListItem
                  ...
                  metadata={dataset.metadata && Array.isArray(dataset.metadata) && dataset.metadata.length > 0
                    ? dataset.metadata[0] 
                    : (dataset.metadata && !Array.isArray(dataset.metadata) ? dataset.metadata : null)}
                  actions={actions}
                  tags={tags}
