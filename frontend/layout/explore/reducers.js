...
export default createReducer(initialState, (builder) => {
  builder
    ...
    // geojson layers (uploaded client-side, no RAG)
    .addCase(actions.addGeojsonLayer, (state, { payload }) => ({
      ...state,
      map: {
        ...state.map,
        geojsonLayers: [...state.map.geojsonLayers, payload],
      },
    }))
    .addCase(actions.removeGeojsonLayer, (state, { payload }) => ({
      ...state,
      map: {
        ...state.map,
        geojsonLayers: state.map.geojsonLayers.filter((l) => l.id !== payload),
      },
    }))
    // layers
